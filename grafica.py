...
# --------------------------------------------------------------------------------------------------
contador = 0
def crearImagePuntos(mejor, peor, promedio,title):
    plt.close()
    global contador
    listX=[]
    listY=[]
    ...
    plt.xlabel(leyenda)
    # plt.ylabel("Aptitud")
    plt.savefig(f"./image/punto/Puntos {contador}.png")
    contador = contador + 1
    plt.close()
    
contadorAptitud = 0
def crearImagenAptitud(mejor, peor, promedio):

    global contadorAptitud
    plt.close()
    ...
    plt.xlabel("Generaciones")
    plt.ylabel("Aptitud")
    plt.savefig(f"./image/aptitud/Aptitud {contadorAptitud}.png")
    contadorAptitud = contadorAptitud + 1
    plt.show()
